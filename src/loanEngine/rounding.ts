...
export const money = (value: Decimal.Value, mode: RoundingMode = 'kopecks') => {
  ...
  if (mode === 'bank') return d.toDecimalPlaces(CURRENCY_DECIMAL_PLACES, Decimal.ROUND_HALF_EVEN)
  return d.toDecimalPlaces(CURRENCY_DECIMAL_PLACES, Decimal.ROUND_HALF_UP)
}
