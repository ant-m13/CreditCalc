...
export const IMPORT_WARNINGS_PAGE_SIZE = 20
...
export function ExportPanel({
  ...
  const pasteParameterCode = async () => {
    try {
      ...
      setLocalStatus({ kind: 'error', text: 'Не удалось прочитать буфер обмена' })
    }
  }
