...
const immutableDefaultConfig: LoanConfig = {
  principal: 7200000, annualRate: 12.4, rateChanges: [], rateChangeMode: 'nextPeriod', issueDate: '2026-06-23', firstPaymentDate: '2026-07-15', firstPaymentInterestOnly: true, termMonths: 240,
