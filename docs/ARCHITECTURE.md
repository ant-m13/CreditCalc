...
- `src/hooks/useLoanCalculation.ts` — подготовка единого снимка расчёта, разворачивание правил, сравнение сценариев и данные обзора.
