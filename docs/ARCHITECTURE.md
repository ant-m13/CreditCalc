...
Перед импортом JSON выполняется проверка структуры, дат, чисел, валюты, типов платежей, льготных периодов и регулярных платежей.
