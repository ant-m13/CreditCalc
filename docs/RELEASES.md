...
7. архивирует содержимое `dist`;
8. создаёт или обновляет GitHub Release с архивом `credit-calculator-dist.zip`.
...
5. запускает тесты;
6. собирает проект с `VITE_BASE_PATH=./`;
7. архивирует содержимое `dist`;
8. прикрепляет `credit-calculator-dist.zip` к GitHub Release.
